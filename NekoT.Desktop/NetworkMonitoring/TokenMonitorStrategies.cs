...
public abstract class TokenMonitorStrategyBase : ITokenMonitorStrategy
{
    ...
    public virtual void OnTokenDetected(TokenExtractedEventArgs e) { _currentTokens = e.Tokens; _currentRequestId = e.RequestUrl; }
    public virtual void OnStreamingDataReceived(string data, string requestId) { }
    public virtual int GetCurrentTokens() => _currentTokens;
    public virtual int GetPredictedTokens() => _currentTokens;
    public virtual void Reset() { _currentTokens = 0; _currentRequestId = string.Empty; }
}
...
public class PreciseTokenMonitorStrategy : TokenMonitorStrategyBase
{
    ...
    public override void OnTokenDetected(TokenExtractedEventArgs e) { base.OnTokenDetected(e); System.Diagnostics.Debug.WriteLine($"[PreciseStrategy] {_providerName}: {e.Tokens} tokens"); }
}
