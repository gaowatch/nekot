...
public partial class App : Application
{
    ...
    private async Task<bool> CheckForceUpdateAsync()
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[App] Force update check failed: {ex.Message}");
        }
    ...
    private void StartUpdateChecker()
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[App] Failed to start update checker: {ex.Message}");
        }
    }
