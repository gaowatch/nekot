...
public class UserSettingsService : INotifyPropertyChanged
{
    ...
    public bool HasAcceptedDisclaimer { get => _settings.DisclaimerAccepted; set { if (_settings.DisclaimerAccepted != value) { _settings.DisclaimerAccepted = value; _settings.DisclaimerAcceptedDate = DateTime.Now; SaveSettings(); OnPropertyChanged(); } } }
    public bool HasCompletedOnboarding { get => _settings.OnboardingCompleted; set { if (_settings.OnboardingCompleted != value) { _settings.OnboardingCompleted = value; _settings.OnboardingCompletedDate = DateTime.Now; SaveSettings(); OnPropertyChanged(); } } }
    public int OnboardingStep { get => _settings.OnboardingStep; set { if (_settings.OnboardingStep != value) { _settings.OnboardingStep = value; SaveSettings(); OnPropertyChanged(); } } }
    public bool OnboardingSkipped { get => _settings.OnboardingSkipped; set { if (_settings.OnboardingSkipped != value) { _settings.OnboardingSkipped = value; SaveSettings(); OnPropertyChanged(); } } }
    public HashSet<string> ConfiguredProviders => _settings.ConfiguredProviders;
    public void MarkProviderConfigured(string provider) { if (_settings.ConfiguredProviders.Add(provider)) SaveSettings(); }
    ...
    public bool ClearDataOnExit { get => _settings.ClearDataOnExit; set { if (_settings.ClearDataOnExit != value) { _settings.ClearDataOnExit = value; SaveSettings(); OnPropertyChanged(); } } }
    public bool AutoBackupData { get => _settings.AutoBackupData; set { if (_settings.AutoBackupData != value) { _settings.AutoBackupData = value; SaveSettings(); OnPropertyChanged(); } } }
    public string? BackupPath { get => _settings.BackupPath; set { if (_settings.BackupPath != value) { _settings.BackupPath = value; SaveSettings(); OnPropertyChanged(); } } }
    ...
    public UserSettings ExportSettings() => new UserSettings { DisclaimerAccepted = _settings.DisclaimerAccepted, DisclaimerAcceptedDate = _settings.DisclaimerAcceptedDate, OnboardingCompleted = _settings.OnboardingCompleted, OnboardingCompletedDate = _settings.OnboardingCompletedDate, OnboardingStep = _settings.OnboardingStep, OnboardingSkipped = _settings.OnboardingSkipped, ConfiguredProviders = new HashSet<string>(_settings.ConfiguredProviders), AppVersion = _settings.AppVersion, Language = _settings.Language, UserAgent = _settings.UserAgent, EnableStealthMode = _settings.EnableStealthMode, DisableDevTools = _settings.DisableDevTools, StartWithWindows = _settings.StartWithWindows, MinimizeToTray = _settings.MinimizeToTray, StartMinimized = _settings.StartMinimized, StartMaximized = _settings.StartMaximized, HomePage = _settings.HomePage, ShowTokenMonitor = _settings.ShowTokenMonitor, LastUpdateCheckTime = _settings.LastUpdateCheckTime, SkippedVersions = new HashSet<string>(_settings.SkippedVersions), LastSelectedProvider = _settings.LastSelectedProvider, LastSelectedModel = _settings.LastSelectedModel, ProxyUrl = _settings.ProxyUrl, BlockTracking = _settings.BlockTracking, BlockAds = _settings.BlockAds, StartupPanel = _settings.StartupPanel };
    public void ImportSettings(UserSettings imported) { _settings.DisclaimerAccepted = imported.DisclaimerAccepted; _settings.DisclaimerAcceptedDate = imported.DisclaimerAcceptedDate; _settings.OnboardingCompleted = imported.OnboardingCompleted; _settings.OnboardingCompletedDate = imported.OnboardingCompletedDate; _settings.OnboardingStep = imported.OnboardingStep; _settings.OnboardingSkipped = imported.OnboardingSkipped; _settings.ConfiguredProviders = imported.ConfiguredProviders ?? new HashSet<string>(); _settings.AppVersion = imported.AppVersion; _settings.Language = imported.Language; _settings.UserAgent = imported.UserAgent; _settings.EnableStealthMode = imported.EnableStealthMode; _settings.DisableDevTools = imported.DisableDevTools; _settings.StartWithWindows = imported.StartWithWindows; _settings.MinimizeToTray = imported.MinimizeToTray; _settings.StartMinimized = imported.StartMinimized; _settings.StartMaximized = imported.StartMaximized; _settings.HomePage = imported.HomePage; _settings.ShowTokenMonitor = imported.ShowTokenMonitor; _settings.LastUpdateCheckTime = imported.LastUpdateCheckTime; _settings.SkippedVersions = imported.SkippedVersions ?? new HashSet<string>(); _settings.LastSelectedProvider = imported.LastSelectedProvider; _settings.LastSelectedModel = imported.LastSelectedModel; _settings.ProxyUrl = imported.ProxyUrl; _settings.BlockTracking = imported.BlockTracking; _settings.BlockAds = imported.BlockAds; _settings.StartupPanel = imported.StartupPanel; SaveSettings(); }
    ...
    private void SaveSettings() { try { var json = JsonSerializer.Serialize(_settings, new JsonSerializerOptions { WriteIndented = true }); File.WriteAllText(_settingsPath, json, System.Text.Encoding.UTF8); SecureStorage.SetFileAccessControl(_settingsPath); } catch { } }
}
