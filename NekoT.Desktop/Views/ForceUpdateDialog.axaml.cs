...
public partial class ForceUpdateDialog : Window
{
    ...
    public void SetUpdateInfo(UpdateCheckResult updateInfo)
    {
        ...
        if (versionText != null) versionText.Text = $"{Strings.Update_ImportantVersion} {updateInfo.LatestVersion?.Version}（{Strings.Update_Required}）";
    ...
    private void OnExitClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e) { if (Application.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop) desktop.Shutdown(); }
}