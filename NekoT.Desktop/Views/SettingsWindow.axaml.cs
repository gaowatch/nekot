...
public partial class SettingsWindow : Window
{
            ...
            if (_languageChanged)
            {
                ...
                if (result)
                {
                    ...
                    if (!string.IsNullOrEmpty(exePath))
                    {
                        ...
                        try { Process.Start(startInfo); Thread.Sleep(1000); } catch { }
                    }
    ...
    private async void OnLanguageChanged(object? sender, SelectionChangedEventArgs e)
    {
        ...
        var newLanguage = LanguageComboBox.SelectedIndex == 1 ? "en" : "zh-CN";
        if (newLanguage != UserSettingsService.Instance.Language) _languageChanged = true;
    }
    ...
    {
        var chatHistoryPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "NekoT", "chat_history.json");
    ...
    {
        var tokenUsagePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "NekoT", "token_usage.json");
    ...
    private void UpdateVersionInfo()
    {
        try
        {
            ...
            VersionText.Text = string.Format(Res.Settings_Version, version != null ? $"{version.Major}.{version.Minor}.{version.Build}" : "1.0.0");
        }
    ...
    private async Task<bool> ShowConfirmAsync(string title, string message)
    {
        ...
        var border = new Border
        {
            ...
            Padding = new Thickness(24), Width = 340,
