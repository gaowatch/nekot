    ...
    private void EnsureWindowOnPrimaryScreen()
    {
        try
        {
            ...
            if (Screens.Primary != null)
            {
                ...
                if (windowWidth > workArea.Width * 0.9)
                    windowWidth = workArea.Width * 0.9;
                if (windowHeight > workArea.Height * 0.9)
                    windowHeight = workArea.Height * 0.9;
                
                Position = new PixelPoint(
                    (int)(workArea.X + (workArea.Width - windowWidth) / 2),
                    (int)(workArea.Y + (workArea.Height - windowHeight) / 2)
                );
