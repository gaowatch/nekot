...
public class WhitelistValidator
{
    private static readonly HashSet<string> Whitelist = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "open.bigmodel.cn", "zhipuai.cn",
        "dashscope.aliyuncs.com", "tongyi.aliyun.com", "qwenlm.aliyun.com",
    ...
    private static readonly HashSet<string> AllowedSuffixes = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "minimax.chat", "minimaxi.com", "minimax.io",
        "deepseek.com", "moonshot.cn", "bigmodel.cn", "zhipuai.cn",
        "aliyuncs.com", "aliyun.com", "siliconflow.cn",
        "baidu.com", "baidubce.com", "xfyun.cn"
    };
