        ...
        try
        {
            ...
            if (root.TryGetProperty("usage", out var usage))
            {
                ...
                if (usage.TryGetProperty("prompt_tokens", out var pt))
                    ...
                    input = it.GetInt32();
                else if (usage.TryGetProperty("input", out var inp))
                    input = inp.GetInt32();
                ...
                if (usage.TryGetProperty("completion_tokens", out var ct))
                    ...
                    output = ot.GetInt32();
                else if (usage.TryGetProperty("output", out var outp))
                    output = outp.GetInt32();

                if (usage.TryGetProperty("total_tokens", out var tt))
                    total = tt.GetInt32();
                else if (usage.TryGetProperty("total", out var tot))
                    total = tot.GetInt32();
                else
                    total = input + output;
